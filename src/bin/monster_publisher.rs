...
use crate::monster_generated::my_game::sample::{Color, Equipment, Monster, MonsterArgs, Vec3, Weapon, WeaponArgs};
...
fn make_monster() -> ZmqMessage {
    ...
    let club = Weapon::create(&mut builder, &WeaponArgs{
        name: Some(weapon_one_name),
        damage: 3,
    });
    let other_club = Weapon::create(&mut builder, &WeaponArgs{
    ...
    let ogre = Monster::create(&mut builder, &MonsterArgs{
